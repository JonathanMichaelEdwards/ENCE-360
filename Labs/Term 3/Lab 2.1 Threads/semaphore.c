...
void write_channel(Chan *channel, void *message) 
{
    ...
    //
    // wait for our chance to access the variable
    ...
    // signal to any readers that there's an update
...
void init_channel(Chan *channel)
{
    ...
    // Initialise the write semaphore is initialised to 1 (channel is empty, free for writing)
...
int main(int argc, char **argv) {
    ...
    sem_destroy(&channel.read);
    sem_destroy(&channel.write);
